        ...
        try {
            ...
            $ACL.GetAccessRules($true,$true,[System.Security.Principal.SecurityIdentifier]) | ForEach-Object {
                ...
                if ($_.IdentityReference -match '^S-1-5-21-[0-9]+-[0-9]+-[0-9]+-[0-9]+') {
                    $Object = Get-zzzado -SID $_.IdentityReference
                    $Names = @()
                    $SIDs = @($Object.objectsid)

                    if ($Recurse -and (@('268435456','268435457','536870912','536870913') -contains $Object.samAccountType)) {
                        $SIDs += Get-zzzngMember -SID $Object.objectsid | Select-Object -ExpandProperty MemberSid
                    }
...
filter Get-DNSZone {
    ...
    if($DNSSearcher) {
        ...
        $Results | Where-Object {$_} | ForEach-Object {
            ...
            $Properties = Convert-zzzldp -Properties $_.Properties
    ...
    if($DNSSearcher) {
        ...
        $Results | Where-Object {$_} | ForEach-Object {
            try {
                ...
                $Properties = Convert-zzzldp -Properties $_.Properties | Select-Object name,distinguishedname,dnsrecord,whencreated,whenchanged
...
filter Get-NetDomainController {
    ...
    if($LDAP -or $DomainController) {
        ...
        Get-zzznc -Domain $Domain -DomainController $DomainController -Credential $Credential -FullData -Filter '(userAccountControl:1.2.840.113556.1.4.803:=8192)'
    }
    else {
    ...
    process {
        if($UserSearcher) {
            ...
            $Results | Where-Object {$_} | ForEach-Object {
                ...
                $User = Convert-zzzldp -Properties $_.Properties
...
function Add-zzznu {
    ...
    if ($GroupName) {
        ...
        if ($Domain) {
            Add-zzzngu -UserName $UserName -GroupName $GroupName -Domain $Domain
            "[*] User $UserName successfully added to group $GroupName in domain $Domain"
        }

        else {
            Add-zzzngu -UserName $UserName -GroupName $GroupName -ComputerName $ComputerName
...
function Get-UserProperty {
    ...
    if($Properties) {
        ...
        Get-zzznuse -Domain $Domain -DomainController $DomainController -PageSize $PageSize -Credential $Credential | Select-Object -Property $Properties
    }
    else {

        Get-zzznuse -Domain $Domain -DomainController $DomainController -PageSize $PageSize -Credential $Credential | Select-Object -First 1 | Get-Member -MemberType *Property | Select-Object -Property 'Name'
    }
}
...
filter Find-UserField {
    ...
    Get-zzznuse -ADSpath $ADSpath -Domain $Domain -DomainController $DomainController -Credential $Credential -Filter "($SearchField=*$SearchTerm*)" -PageSize $PageSize | Select-Object samaccountname,$SearchField
}
...
function Add-zzzoa {
    ...
    begin {
        ...
        if($PrincipalSID) {
            ...
            $Principal = Get-zzzado -Domain $Domain -DomainController $DomainController -Name $PrincipalName -SamAccountName $PrincipalSamAccountName -PageSize $PageSize
...
function Get-zzznc {
    ...
    process {
        ...
        if ($CompSearcher) {
            ...
            Write-Verbose "Get-zzznc filter : '$CompFilter'"
                ...
                $Results | Where-Object {$_} | ForEach-Object {
                    ...
                    if($Up) {
                        ...
                        if ($FullData) {
                            ...
                            $Computer = Convert-zzzldp -Properties $_.Properties
        ...
        if($ObjectSearcher) {
            ...
            $Results | Where-Object {$_} | ForEach-Object {
                if($ReturnRaw) {
                    ...
                    Convert-zzzldp -Properties $_.Properties
                }
            }
            $Results.dispose()
...
function Set-ADObject {
    ...
    $RawObject = Get-zzzado -ReturnRaw @Arguments
...
function Invoke-DowngradeAccount {
    ...
    process {
        ...
        $UACValues = Get-zzzado @Arguments | select useraccountcontrol | ConvertF-zzzuv
...
function Get-zzzcp {
    ...
    if($Properties) {
        ...
        Get-zzznc -Domain $Domain -DomainController $DomainController -Credential $Credential -FullData -PageSize $PageSize | Select-Object -Property $Properties
    }
    else {

        Get-zzznc -Domain $Domain -DomainController $DomainController -Credential $Credential -FullData -PageSize $PageSize | Select-Object -first 1 | Get-Member -MemberType *Property | Select-Object -Property "Name"
    }
}
...
function Find-zzzcf {
    ...
    process {
        Get-zzznc -ADSpath $ADSpath -Domain $Domain -DomainController $DomainController -Credential $Credential -FullData -Filter "($SearchField=*$SearchTerm*)" -PageSize $PageSize | Select-Object samaccountname,$SearchField
    }
}
            ...
            try {
                ...
                $Results | Where-Object {$_} | ForEach-Object {
                    if ($FullData) {
                        ...
                        $OU = Convert-zzzldp -Properties $_.Properties
            ...
            try {
                ...
                $Results | Where-Object {$_} | ForEach-Object {
                    if ($FullData) {
                        ...
                        $Site = Convert-zzzldp -Properties $_.Properties
            ...
            try {
                ...
                $Results | Where-Object {$_} | ForEach-Object {
                    if ($FullData) {
                        ...
                        Convert-zzzldp -Properties $_.Properties | Where-Object { $_.siteobject -match "CN=$SiteName" }
                    }
                    else {
...
function Get-zzzdsid {
    ...
    $DCSID = Get-zzznc -Domain $Domain -DomainController $DomainController -FullData -Filter '(userAccountControl:1.2.840.113556.1.4.803:=8192)' | Select-Object -First 1 -ExpandProperty objectsid
    if($DCSID) {
    ...
    process {
        if($GroupSearcher) {
            ...
            if ($UserName) {
                ...
                $User = Get-zzzado -SamAccountName $UserName -Domain $Domain -DomainController $DomainController -Credential $Credential -ReturnRaw -PageSize $PageSize | Select-Object -First 1
                ...
                if($User) {
                    ...
                    $UserDirectoryEntry.TokenGroups | ForEach-Object {
                        ...
                        if($GroupSid -notmatch '^S-1-5-32-.*') {
                            if($FullData) {
                                $Group = Get-zzzado -SID $GroupSid -PageSize $PageSize -Domain $Domain -DomainController $DomainController -Credential $Credential
                ...
                $Results | Where-Object {$_} | ForEach-Object {
                    ...
                    if ($FullData) {
                        ...
                        $Group = Convert-zzzldp -Properties $_.Properties
                        $Group.PSObject.TypeNames.Add('PowerView.Group')
                        $Group
                    }
                    else {
    ...
    process {
        if ($GroupSearcher) {
            if ($Recurse -and $UseMatchingRule) {
                ...
                if ($GroupName) {
                    $Group = Get-zzzng -AllTypes -GroupName $GroupName -Domain $TargetDomain -DomainController $TargetDomainController -Credential $Credential -FullData -PageSize $PageSize
                }
                elseif ($SID) {
                    $Group = Get-zzzng -AllTypes -SID $SID -Domain $TargetDomain -DomainController $TargetDomainController -Credential $Credential -FullData -PageSize $PageSize
                }
                else {

                    $SID = (Get-zzzdsid -Domain $TargetDomain -DomainController $TargetDomainController) + "-512"
                    $Group = Get-zzzng -AllTypes -SID $SID -Domain $TargetDomain -DomainController $TargetDomainController -Credential $Credential -FullData -PageSize $PageSize
                }
            ...
            $Members | Where-Object {$_} | ForEach-Object {
                ...
                if($Properties) {
                    ...
                    if ($FullData) {
                        $GroupMember = Convert-zzzldp -Properties $Properties
                    }
                    else {
                    ...
                    if ($Recurse -and !$UseMatchingRule -and $IsGroup -and $MemberName) {
                        if($FullData) {
                            Get-zzzngMember -FullData -Domain $MemberDomain -DomainController $TargetDomainController -Credential $Credential -GroupName $MemberName -Recurse -PageSize $PageSize
                        }
                        else {
                            Get-zzzngMember -Domain $MemberDomain -DomainController $TargetDomainController -Credential $Credential -GroupName $MemberName -Recurse -PageSize $PageSize
                        }
                    }
                }
            }
...
function Get-zzznfs {
    ...
    Get-zzznuse -Domain $Domain -DomainController $DomainController -Credential $Credential -PageSize $PageSize -Filter $filter | Where-Object {$_} | Where-Object {
...
function Get-zzzds {
    ...
    function Get-zzzdsV1 {
        ...
        if($DFSsearcher) {
            ...
            try {
                ...
                Write-Warning "Get-zzzdsV1 error : $_"
            }
            $DFSshares | Sort-Object -Property "RemoteServerName"
        }
    }

    function Get-zzzdsV2 {
        [CmdletBinding()]
        param(
            [String]
            $Domain,
        ...
        if($DFSsearcher) {
            ...
            try {
                ...
                Write-Warning "Get-zzzdsV2 error : $_"
            }
    ...
    if ( ($Version -eq "all") -or ($Version.endsWith("1")) ) {
        $DFSshares += Get-zzzdsV1 -Domain $Domain -DomainController $DomainController -Credential $Credential -ADSpath $ADSpath -PageSize $PageSize
    }
    if ( ($Version -eq "all") -or ($Version.endsWith("2")) ) {
        $DFSshares += Get-zzzdsV2 -Domain $Domain -DomainController $DomainController -Credential $Credential -ADSpath $ADSpath -PageSize $PageSize
    }
...
function Get-zzzngpo {
    ...
    process {
        if ($GPOSearcher) {
            ...
            if($ComputerName) {
                $GPONames = @()
                $Computers = Get-zzznc -ComputerName $ComputerName -Domain $Domain -DomainController $DomainController -FullData -PageSize $PageSize
                ...
                ForEach($ComputerOU in $ComputerOUs) {
                    $GPONames += Get-zzzno -Domain $Domain -DomainController $DomainController -ADSpath $ComputerOU -FullData -PageSize $PageSize | ForEach-Object { 
                ...
                if($ComputerSite -and ($ComputerSite -notlike 'Error*')) {
                    $GPONames += Get-zzzns -SiteName $ComputerSite -FullData | ForEach-Object {
                        if($_.gplink) {
                            $_.gplink.split("][") | ForEach-Object {
                                if ($_.startswith("LDAP")) {
                                    $_.split(";")[0]
                ...
                $GPONames | Where-Object{$_ -and ($_ -ne '')} | ForEach-Object {
                    ...
                    try {
                        ...
                        $Results | Where-Object {$_} | ForEach-Object {
                            $Out = Convert-zzzldp -Properties $_.Properties
...
function New-GPOImmediateTask {
    ...
    $GPOs = Get-zzzngpo -GPOname $GPOname -DisplayName $GPODisplayName -Domain $Domain -DomainController $DomainController -ADSpath $ADSpath -Credential $Credential 
...
function Get-zzzngpoGroup {
    ...
    Get-zzzngpo -GPOName $GPOname -DisplayName $DisplayName -Domain $Domain -DomainController $DomainController -ADSpath $ADSpath -PageSize $PageSize | ForEach-Object {
...
function Find-zzzgl {
    ...
    if($UserName) {
        ...
        $User = Get-zzznuse -UserName $UserName -Domain $Domain -DomainController $DomainController -PageSize $PageSize | Select-Object -First 1
    ...
    elseif($GroupName) {
        ...
        $Group = Get-zzzng -GroupName $GroupName -Domain $Domain -DomainController $DomainController -FullData -PageSize $PageSize | Select-Object -First 1
    ...
    if($TargetSIDs[0] -and ($TargetSIDs[0] -ne '*')) {
        $TargetSIDs += Get-zzzng -Domain $Domain -DomainController $DomainController -PageSize $PageSize -UserName $ObjectSamAccountName -RawSids
    }
    ...
    $GPOgroups = Get-zzzngpoGroup @GPOGroupArgs | ForEach-Object {
    ...
    $GPOgroups | ForEach-Object {
        ...
        Get-zzzno -Domain $Domain -DomainController $DomainController -GUID $GPOguid -FullData -PageSize $PageSize | ForEach-Object {
            if($Filters) {


                $OUComputers = Get-zzznc -Domain $Domain -DomainController $DomainController -Credential $Credential -ADSpath $_.ADSpath -FullData -PageSize $PageSize | Where-Object {
                    $_.adspath -match ($Filters.Value)
                } | ForEach-Object { $_.dnshostname }
            }
            else {
                $OUComputers = Get-zzznc -Domain $Domain -DomainController $DomainController -Credential $Credential -ADSpath $_.ADSpath -PageSize $PageSize
            }
            ...
            if($OUComputers) {
                ...
                ForEach ($TargetSid in $TargetObjectSIDs) {
                    $Object = Get-zzzado -SID $TargetSid -Domain $Domain -DomainController $DomainController -Credential $Credential -PageSize $PageSize
        ...
        Get-zzzns -Domain $Domain -DomainController $DomainController -GUID $GPOguid -PageSize $PageSize -FullData | ForEach-Object {
...
function Find-zzzgca {
    ...
    process {
        ...
        if($ComputerName) {
            ...
            $ComputerSite = (Get-SiteName -ComputerName $ComputerName).SiteName
            if($ComputerSite -and ($ComputerSite -notlike 'Error*')) {
                $GPOGroups += Get-zzzns -SiteName $ComputerSite -FullData | ForEach-Object {
                    if($_.gplink) {
                        $_.gplink.split("][") | ForEach-Object {
                            if ($_.startswith("LDAP")) {
                                $_.split(";")[0]
        ...
        $TargetOUs | Where-Object {$_} | ForEach-Object {
            ...
            $GPOLinks = Get-zzzno -Domain $Domain -DomainController $DomainController -ADSpath $_ -FullData -PageSize $PageSize | ForEach-Object { 
        ...
        $GPOgroups | Sort-Object -Property GPOName -Unique | ForEach-Object {
            ...
            $GPOMembers | ForEach-Object {
                ...
                $Object = Get-zzzado -Domain $Domain -DomainController $DomainController -PageSize $PageSize -SID $_
                ...
                if($Recurse -and $GPOComputerAdmin.isGroup) {
                    ...
                    Get-zzzngMember -Domain $Domain -DomainController $DomainController -SID $_ -FullData -Recurse -PageSize $PageSize | ForEach-Object {
...
function Get-zzzdp {
    ...
    if($Source -eq "Domain") {
        ...
        $GPO = Get-zzzngpo -Domain $Domain -DomainController $DomainController -GPOname "{31B2F340-016D-11D2-945F-00C04FB984F9}"
    ...
    elseif($Source -eq "DC") {
        ...
        $GPO = Get-zzzngpo -Domain $Domain -DomainController $DomainController -GPOname "{6AC1786C-016F-11D2-945F-00C04FB984F9}"
                        ...
                        $Members | ForEach-Object {
                            ...
                            if($Recurse -and $IsGroup) {
                                if($IsDomain) {
                                  ...
                                  Get-zzzngMember -GroupName $GroupName -Domain $FQDN -FullData -Recurse | ForEach-Object {
                                ...
                                Get-zzznlg -ComputerName $Server -GroupName $ObjName -Recurse
                              }
                            }
                        }
                    }
...
function Invoke-UserHunter {
    ...
    begin {
            ...
            if($Stealth) {
                ...
                ForEach ($Domain in $TargetDomains) {
                    if (($StealthSource -eq "File") -or ($StealthSource -eq "All")) {
                        ...
                        $ComputerName += Get-zzznfs -Domain $Domain -DomainController $DomainController
                    }
                    if (($StealthSource -eq "DFS") -or ($StealthSource -eq "All")) {
                        Write-Verbose "[*] Querying domain $Domain for DFS Servers..."
                        $ComputerName += Get-zzzds -Domain $Domain -DomainController $DomainController | ForEach-Object {$_.RemoteServerName}
                    }
                ...
                ForEach ($Domain in $TargetDomains) {
                    ...
                    $ComputerName += Get-zzznc @Arguments
                }
            }
        ...
        elseif($TargetServer) {
            ...
            $TargetUsers = Get-zzznlg $TargetServer -Recurse | Where-Object {(-not $_.IsGroup) -and $_.IsDomain } | ForEach-Object {
                $User = New-Object PSObject
        ...
        elseif($UserADSpath -or $UserFilter -or $AdminCount) {
            ForEach ($Domain in $TargetDomains) {
                ...
                $TargetUsers += Get-zzznuse @Arguments | ForEach-Object {
                    $User = New-Object PSObject
            ...
            ForEach ($Domain in $TargetDomains) {
                ...
                $TargetUsers += Get-zzzngMember -GroupName $GroupName -Domain $Domain -DomainController $DomainController
            }
        }
...
function Invoke-ProcessHunter {
    ...
    begin {
        ...
        if(!$ComputerName) { 
            ...
            ForEach ($Domain in $TargetDomains) {
                Write-Verbose "[*] Querying domain $Domain for hosts"
                $ComputerName += Get-zzznc -Domain $Domain -DomainController $DomainController -Credential $Credential -Filter $ComputerFilter -ADSpath $ComputerADSpath
            }
        ...
        if(!$ProcessName) {
            ...
            elseif($UserADSpath -or $UserFilter) {
                ForEach ($Domain in $TargetDomains) {
                    Write-Verbose "[*] Querying domain $Domain for users"
                    $TargetUsers += Get-zzznuse -Domain $Domain -DomainController $DomainController -Credential $Credential -ADSpath $UserADSpath -Filter $UserFilter | ForEach-Object {
                        $_.samaccountname
                    }  | Where-Object {$_}
                }
            }
                ...
                ForEach ($Domain in $TargetDomains) {
                    Write-Verbose "[*] Querying domain $Domain for users of group '$GroupName'"
                    $TargetUsers += Get-zzzngMember -GroupName $GroupName -Domain $Domain -DomainController $DomainController -Credential $Credential| ForEach-Object {
                        $_.MemberName
                    }
                }
            }
...
function Invoke-Formatter {
    ...
    begin {
        ...
        Write-Verbose "[*] Running Invoke-Formatter with delay of $Delay"
        ...
        if(!$ComputerName) { 
            ...
            ForEach ($Domain in $TargetDomains) {
                Write-Verbose "[*] Querying domain $Domain for hosts"
                $ComputerName += Get-zzznc -Domain $Domain -DomainController $DomainController -Filter $ComputerFilter -ADSpath $ComputerADSpath
            }
        ...
        if($ShareList) {
            ...
            if(!$ComputerName) {
                ...
                if($SearchSYSVOL) {
                    ...
                    ForEach ($Domain in $TargetDomains) {
                        Write-Verbose "[*] Querying domain $Domain for hosts"
                        $ComputerName += Get-zzznc -Filter $ComputerFilter -ADSpath $ComputerADSpath -Domain $Domain -DomainController $DomainController
                    }
...
function Find-zzzlaa {
    ...
    begin {
        ...
        Write-Verbose "[*] Running Find-zzzlaa with delay of $Delay"
...
function Get-zzzes {
    ...
    Get-zzznc -FullData @PSBoundParameters | ForEach-Object {
...
function Invoke-EnumerateLocalAdmin {
    ...
    begin {
        ...
        if($TrustGroups) {
            ...
            $TrustGroupNames = Find-zzzfg -Domain $Domain -DomainController $DomainController | ForEach-Object { $_.GroupName } | Sort-Object -Unique

            $TrustGroupsSIDs = $TrustGroupNames | ForEach-Object { 


                Get-zzzng -Domain $Domain -DomainController $DomainController -GroupName $_ -FullData | Where-Object { $_.objectsid -notmatch "S-1-5-32-544" } | ForEach-Object { $_.objectsid }
            }


            $DomainSID = Get-zzzdsid -Domain $Domain -DomainController $DomainController
        }
        ...
        $HostEnumBlock = {
            ...
            if($Up) {
                ...
                if($API) {
                    $LocalAdmins = Get-zzznlg -ComputerName $ComputerName -API
                }
                else {
                    $LocalAdmins = Get-zzznlg -ComputerName $ComputerName
                }
...
function Get-zzzndt {
    ...
    process {
        ...
        if($LDAP -or $ADSPath) {
            ...
            $SourceSID = Get-zzzdsid -Domain $SourceDomain -DomainController $DomainController
...
function Find-zzzfu {
    ...
    function Get-ForeignUser {
        ...
        Get-zzznuse -Domain $Domain -DomainController $DomainController -UserName $UserName -PageSize $PageSize -Filter '(memberof=*)' | ForEach-Object {
...
function Find-zzzfg {
    ...
    function Get-ForeignGroup {
        ...
        Get-zzzng -GroupName $GroupName -Filter '(member=*)' -Domain $Domain -DomainController $DomainController -FullData -PageSize $PageSize | Where-Object {
...
function Find-zzzmsg {



    Get-zzzng -FullData -Filter '(managedBy=*)' | Select-Object -Unique distinguishedName,managedBy,cn | ForEach-Object {


        $group_manager = Get-zzzado -ADSPath $_.managedBy | Select-Object cn,distinguishedname,name,samaccounttype,samaccountname
        ...
        $xacl = Get-zzzoacl -ADSPath $_.distinguishedname -Rights WriteMembers
    ...
    while($Domains.Count -ne 0) {
        ...
        if ($Domain -and ($Domain.Trim() -ne "") -and (-not $SeenDomains.ContainsKey($Domain))) {
            ...
            try {
                ...
                if($LDAP -or $DomainController) {
                    $Trusts = Get-zzzndt -Domain $Domain -LDAP -DomainController $DomainController -PageSize $PageSize -Credential $Credential
                }
                else {
                    $Trusts = Get-zzzndt -Domain $Domain -PageSize $PageSize -Credential $Credential
                }
                ...
                if(-not ($LDAP -or $DomainController) ) {
                    $Trusts += Get-zzznftr -Forest $Domain -Credential $Credential
                }
